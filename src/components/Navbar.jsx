...
import { ShoppingCart, Menu, X, Home, Cake, Heart, Truck, MessageSquare, Star, User, Store, LogOut } from 'lucide-react';
...
const Navbar = () => {
  ...
  const navItems = [
    ...
    { name: 'Pastries', path: '/pastries', icon: Cake },
        ...
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex items-center space-x-4">
            ...
            <button
              ...
              className="lg:hidden p-3 text-gray-700 hover:text-cake-red hover:bg-cake-pink/50 rounded-xl transition-all duration-300"
            >
